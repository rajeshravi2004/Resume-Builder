...
export const SettingsPage = () => {
  ...
  const importWorkspace = event => {
    ...
    reader.onload = () => {
      ...
      } catch { alert('This is not a valid Resume Studio workspace backup.') }
    }
